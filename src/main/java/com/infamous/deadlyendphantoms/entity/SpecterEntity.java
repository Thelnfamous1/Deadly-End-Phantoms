...
public class SpecterEntity extends FlyingEntity implements IMob {
    ...
    class OrbitPointGoal extends MoveGoal {
         ...
         */
        public boolean shouldExecute() {
            return SpecterEntity.this.getAttackTarget() == null || SpecterEntity.this.attackPhase == AttackPhase.CIRCLE;
        }
        ...
        public void tick() {
            ...
            if (SpecterEntity.this.orbitOffset.y < SpecterEntity.this.getPosY() && !SpecterEntity.this.world.isAirBlock(SpecterEntity.this.getPosition().down(1))) {
                this.field_203152_e = Math.max(1.0F, this.field_203152_e);
                this.updateOrbitPositionAndOffset();
            }

            if (SpecterEntity.this.orbitOffset.y > SpecterEntity.this.getPosY() && !SpecterEntity.this.world.isAirBlock(SpecterEntity.this.getPosition().up(1))) {
        ...
        private void updateOrbitPositionAndOffset() {
            if (BlockPos.ZERO.equals(SpecterEntity.this.orbitPosition)) {
                SpecterEntity.this.orbitPosition = SpecterEntity.this.getPosition();
            }

            this.field_203150_c += this.field_203153_f * 15.0F * ((float)Math.PI / 180F);
            SpecterEntity.this.orbitOffset = Vector3d.copy(SpecterEntity.this.orbitPosition).add((double)(this.field_203151_d * MathHelper.cos(this.field_203150_c)), (double)(-4.0F + this.field_203152_e), (double)(this.field_203151_d * MathHelper.sin(this.field_203150_c)));
        }
    }
    ...
    class PickAttackGoal extends Goal {
        ...
        public void startExecuting() {
            this.tickDelay = 10;
            SpecterEntity.this.attackPhase = AttackPhase.CIRCLE;
            this.orbitTarget();
        }
         ...
         */
        public void tick() {
            if (SpecterEntity.this.attackPhase == AttackPhase.CIRCLE) {
                --this.tickDelay;
                if (this.tickDelay <= 0) {
                    if(SpecterEntity.this.getAttackTarget() != null && SpecterEntity.this.getAttackTarget().isElytraFlying()){
                        ...
                        SpecterEntity.this.attackPhase = AttackPhase.SWOOP;
                        this.orbitTarget();
                        this.tickDelay = (8 + SpecterEntity.this.rand.nextInt(4)) * 20;
                        SpecterEntity.this.playSound(SoundEvents.ENTITY_PHANTOM_SWOOP, 10.0F, 0.95F + SpecterEntity.this.rand.nextFloat() * 0.1F);
                    }
        ...
        private void orbitTarget() {
            // func_233580_cy_ = getBlockPos()
            SpecterEntity.this.orbitPosition = SpecterEntity.this.getAttackTarget().getPosition().up(20 + SpecterEntity.this.rand.nextInt(20));
    ...
    class SweepAttackGoal extends MoveGoal {
         ...
         */
        public boolean shouldExecute() {
            return SpecterEntity.this.getAttackTarget() != null && SpecterEntity.this.attackPhase == AttackPhase.SWOOP;
        }
        ...
        public void tick() {
            ...
            if (SpecterEntity.this.getBoundingBox().grow((double)0.2F).intersects(livingentity.getBoundingBox())) {
                ...
                if (!SpecterEntity.this.isSilent()) {
                    SpecterEntity.this.world.playEvent(1039, SpecterEntity.this.getPosition(), 0);
                }
    ...
    class PursueElytraFlyerGoal extends MoveGoal {
